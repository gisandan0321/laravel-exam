...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Comments: function Comments() {
      return Promise.all(/*! import() */[__webpack_require__.e(12), __webpack_require__.e(10)]).then(__webpack_require__.bind(null, /*! ./comments */ "./resources/js/pages/posts/comments/index.vue"));
    }
  },
  data: function data() {
    return {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "block" }, [
        ...
        _c("div", { staticClass: "inline-block align-top ml-2" }, [
          ...
          _c("p", { staticClass: "text-gray-600 text-sm" }, [
            _vm._v(_vm._s(_vm._f("moment")(_vm.post.createdAt, "from", "now")))
          ])
        ]),
        _vm._v(" "),
        _vm._m(0)
      ...
      _vm._v(" "),
      _c("h1", { staticClass: "block text-gray-700 py-5" }, [
        _vm._v(_vm._s(_vm.post.title))
      ]),
      _vm._v(" "),
      _c("comments", { staticClass: "block mt-4" })
    ],
    1
  )
}
